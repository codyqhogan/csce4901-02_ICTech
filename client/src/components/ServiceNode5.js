...
const miso = require('../../assets/servImages/petco.jpg');
  ...
  return (
    <View>
      <Pressable style={[styles.servContainer, { height: 125 }]}>
        ...
        <Text style={styles.servHeader}>Petco</Text>
        <Text style={styles.servHeader2}>Shopping</Text>
        <Feather
          name="star"
          size={20}
          color={isDarkMode === 'light' ? pawYellow : pawGrey}
        ...
        <Text style={styles.servHeader2}>
          We proudly offer a large variety of pet nutrition products and supplies competitively
          priced for dogs, cats, reptiles, fish, birds and small animals.
        </Text>
      </Pressable>
