...
const miso = require('../../assets/servImages/dentonParks.png');
  ...
  return (
    <View>
      <Pressable style={[styles.servContainer, { height: 125 }]}>
        ...
        <Text style={styles.servHeader}>Denton Parks</Text>
        <Text style={styles.servHeader2}>Dog Park</Text>
        <Feather
          name="star"
          size={20}
          color={isDarkMode === 'light' ? pawYellow : pawGrey}
        ...
        <Text style={styles.servHeader2}>
          Explore one of our parks, trails, playgrounds, and pavilions.
        </Text>
      </Pressable>
